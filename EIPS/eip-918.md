...
Internal interface function \_epoch, meant to be overridden in implementation to define a cutpoint for mutating mining variables in preparation for the next phase of mine.

``` solidity
function _epoch(uint256 nonce) internal returns (uint);
```
